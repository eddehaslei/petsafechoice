...
serve(async (req) => {
  ...
  try {
    ...
    // Search affiliates table by product_name only (case-insensitive). No other filters.
    // Note: ilike expects a pattern; passing the raw term behaves as exact match ignoring case.
